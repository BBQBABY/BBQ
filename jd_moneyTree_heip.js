...
function shareCodesFormat() {
  return new Promise(async resolve => {
    $.newShareCodes = [];
    let inviteCodes = [
      'miVVXp7ZnxN5OQ303YU8Cg@GWajecJZOEIeZQIaS6srXw@zfEx3C-J2bWtBtwprjIRKg@MgTaVFUWNpNNMkLp0oCOHA@gZ_Xnt4ea0csrbRfQetyuA@yOT55_qh0jQ3QV3tuVVT-cAdoUJQ3Dik@NaUN6BJyX5sP9zsDn79S7Q@lAf5BVPq_uuxV_krNhEpiQ',
      'miVVXp7ZnxN5OQ303YU8Cg@GWajecJZOEIeZQIaS6srXw@zfEx3C-J2bWtBtwprjIRKg@MgTaVFUWNpNNMkLp0oCOHA@gZ_Xnt4ea0csrbRfQetyuA@yOT55_qh0jQ3QV3tuVVT-cAdoUJQ3Dik@NaUN6BJyX5sP9zsDn79S7Q@lAf5BVPq_uuxV_krNhEpiQ'
    ];
    if ($.shareCodesArr[$.index - 1]) {
      $.newShareCodes = $.shareCodesArr[$.index - 1].split('@');
    } else {
      console.log(`由于您第${$.index}个京东账号未提供shareCode,将为作者助力\n`)
