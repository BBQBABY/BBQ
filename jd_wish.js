...
[task_local]
#众筹许愿池
27 0,2,18 * * * https://raw.githubusercontent.com/BBQBABY/BBQ/main/jd_wish.js, tag=众筹许愿池, img-url=https://raw.githubusercontent.com/Orz-3/mini/master/Color/jd.png, enabled=true

================Loon==============
[Script]
cron "27 0,2,18 * * *" script-path=https://raw.githubusercontent.com/BBQBABY/BBQ/main/jd_wish.js,tag=众筹许愿池

===============Surge=================
众筹许愿池 = type=cron,cronexp="27 0,2,18 * * *",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/BBQBABY/BBQ/main/jd_wish.js

============小火箭=========
众筹许愿池 = type=cron,script-path=https://raw.githubusercontent.com/BBQBABY/BBQ/main/jd_wish.js, cronexpr="27 0,2,18 * * *", timeout=3600, enable=true
 */
const $ = new Env('众筹许愿池');
...
!(async () => {
  ...
  let res = await getAuthorShareCode('https://raw.githubusercontent.com/captainz236/sharecode/main/jdsc/wish.json')
  if (!res) {
    $.http.get({url: 'https://raw.githubusercontent.com/captainz236/sharecode/main/jdsc/wish.json'}).then((resp) => {}).catch((e) => console.log('刷新CDN异常', e));
    await $.wait(1000)
    res = await getAuthorShareCode('https://raw.githubusercontent.com/captainz236/sharecode/main/jdsc/wish.json')
  }
