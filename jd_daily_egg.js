...
[task_local]
#天天提鹅
10 * * * * https://raw.githubusercontent.com/BBQBABY/BBQ/main/jd_daily_egg.js, tag=天天提鹅, img-url=https://raw.githubusercontent.com/58xinian/icon/master/jdte.png, enabled=true

================Loon==============
[Script]
cron "10 * * * *" script-path=https://raw.githubusercontent.com/BBQBABY/BBQ/main/jd_daily_egg.js,tag=天天提鹅

===============Surge=================
天天提鹅 = type=cron,cronexp="10 * * * *",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/BBQBABY/BBQ/main/jd_daily_egg.js

============小火箭=========
天天提鹅 = type=cron,script-path=https://raw.githubusercontent.com/BBQBABY/BBQ/main/jd_daily_egg.js, cronexpr="10 * * * *", timeout=3600, enable=true
 */
const $ = new Env('天天提鹅');
