...
[task_local]
#京喜财富岛
1 * * * * https://raw.githubusercontent.com/BBQBABY/BBQ/main/jd_cfd.js, tag=京喜财富岛, img-url=https://raw.githubusercontent.com/58xinian/icon/master/jxcfd.png, enabled=true

================Loon==============
[Script]
cron "1 * * * *" script-path=https://raw.githubusercontent.com/BBQBABY/BBQ/main/jd_cfd.js,tag=京喜财富岛

===============Surge=================
京喜财富岛 = type=cron,cronexp="1 * * * *",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/BBQBABY/BBQ/main/jd_cfd.js

============小火箭=========
京喜财富岛 = type=cron,script-path=https://raw.githubusercontent.com/BBQBABY/BBQ/main/jd_cfd.js, cronexpr="1 * * * *", timeout=3600, enable=true
 */
...
!(async () => {
  ...
  if (!res) {
    $.http.get({url: 'https://raw.githubusercontent.com/Aaron-lv/updateTeam/master/shareCodes/cfd.json'}).then((resp) => {}).catch((e) => console.log('刷新CDN异常', e));
    await $.wait(1000)
