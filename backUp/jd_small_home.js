...
[task_local]
#东东小窝
16 22 * * * https://raw.githubusercontent.com/captainz236/goodjob/main/jd_small_home.js, tag=东东小窝, img-url=https://raw.githubusercontent.com/58xinian/icon/master/ddxw.png, enabled=true

================Loon==============
[Script]
cron "16 22 * * *" script-path=https://raw.githubusercontent.com/captainz236/goodjob/main/jd_small_home.js, tag=东东小窝

===============Surge=================
东东小窝 = type=cron,cronexp="16 22 * * *",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/captainz236/goodjob/main/jd_small_home.js

============小火箭=========
东东小窝 = type=cron,script-path=https://raw.githubusercontent.com/captainz236/goodjob/main/jd_small_home.js, cronexpr="16 22 * * *", timeout=3600, enable=true
 */
const $ = new Env('东东小窝');
