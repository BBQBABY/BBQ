/*
第一个号助力作者，其他号助力第一个CK
cron 10 2,9,17 * * * https://raw.githubusercontent.com/BBQBABY/BBQ/main/jd_vivo.js
...
!(async () => {
    ...
    let res = [];
    try{res = await getAuthorShareCode('https://raw.githubusercontent.com/captainz236/sharecode/main/vivo.json');}catch (e) {}
    if(!res){
        try{res = await getAuthorShareCode('https://raw.githubusercontent.com/captainz236/sharecode/main/vivo.json');}catch (e) {}
        if(!res){res = [];}
    }
