...
[task_local]
#东东超市
11 * * * * https://raw.githubusercontent.com/BBQBABY/BBQ/main/jd_superMarket.js, tag=东东超市, img-url=https://raw.githubusercontent.com/58xinian/icon/master/jxc.png, enabled=true
===========Loon===============
[Script]
cron "11 * * * *" script-path=https://raw.githubusercontent.com/BBQBABY/BBQ/main/jd_superMarket.js,tag=东东超市
=======Surge===========
东东超市 = type=cron,cronexp="11 * * * *",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/BBQBABY/BBQ/main/jd_superMarket.js
==============小火箭=============
东东超市 = type=cron,script-path=https://raw.githubusercontent.com/BBQBABY/BBQ/main/jd_superMarket.js, cronexpr="11 * * * *", timeout=3600, enable=true
 */
const $ = new Env('东东超市');
...
async function bigWinner() {
  let res = await getAuthorShareCode2('https://raw.githubusercontent.com/captainz236/sharecode/main/jdsc/fcdyj.json')
  if (!res) {
    $.http.get({url: 'https://raw.githubusercontent.com/captainz236/sharecode/main/jdsc/fcdyj.json'}).then((resp) => {}).catch((e) => $.log('刷新CDN异常', e));
    await $.wait(1000)
    res = await getAuthorShareCode2('https://raw.githubusercontent.com/captainz236/sharecode/main/jdsc/fcdyj.json')
  }
