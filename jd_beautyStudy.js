...
40 7,12,19 * * * jd_beautyStudy.js, tag=美丽研究院, img-url=https://raw.githubusercontent.com/Orz-3/mini/master/Color/jd.png, enabled=true
============Quantumultx===============
[task_local]
# 美丽研究院(修复版)
40 7,12,19 * * * https://raw.githubusercontent.com/BBQBABY/BBQ/main/jd_beautyStudy.js, tag=美丽研究院(修复版), img-url=https://raw.githubusercontent.com/Orz-3/mini/master/Color/jd.png, enabled=true

================Loon==============
[Script]
cron "40 7,12,19 * * *" script-path=https://raw.githubusercontent.com/BBQBABY/BBQ/main/jd_beautyStudy.js,tag=美丽研究院(修复版)

===============Surge=================
美丽研究院(修复版) = type=cron,cronexp="40 7,12,19 * * *",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/BBQBABY/BBQ/main/jd_beautyStudy.js

============小火箭=========
美丽研究院(修复版) = type=cron,script-path=https://raw.githubusercontent.com/BBQBABY/BBQ/main/jd_beautyStudy.js, cronexpr="40 7,12,19 * * *", timeout=3600, enable=true
 */
const $ = new Env('美丽研究院');
