...
活动入口：京东APP首页-领京豆
更新地址：https://raw.githubusercontent.com/BBQBABY/BBQ/main/jd_bean_home.js
已支持IOS双京东账号, Node.js支持N个京东账号
脚本兼容: QuantumultX, Surge, Loon, 小火箭，JSBox, Node.js
============Quantumultx===============
[task_local]
#领京豆额外奖励
23 1,12,22 * * * https://raw.githubusercontent.com/BBQBABY/BBQ/main/jd_bean_home.js, tag=领京豆额外奖励, img-url=https://raw.githubusercontent.com/58xinian/icon/master/jd_bean_home.png, enabled=true

================Loon==============
[Script]
cron "23 1,12,22 * * *" script-path=https://raw.githubusercontent.com/BBQBABY/BBQ/main/jd_bean_home.js, tag=领京豆额外奖励

===============Surge=================
领京豆额外奖励 = type=cron,cronexp="23 1,12,22 * * *",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/BBQBABY/BBQ/main/jd_bean_home.js

============小火箭=========
领京豆额外奖励 = type=cron,script-path=https://raw.githubusercontent.com/BBQBABY/BBQ/main/jd_bean_home.js, cronexpr="23 1,12,22 * * *", timeout=3600, enable=true
 */
...
!(async () => {
  $.newShareCodes = []
  $.authorCode = await getAuthorShareCode('https://raw.githubusercontent.com/captainz236/sharecode/main/jdsc/jd_updateBeanHome.json')
  if (!$.authorCode) {
    $.http.get({url: 'https://raw.githubusercontent.com/captainz236/sharecode/main/jdsc/jd_updateBeanHome.json'}).then((resp) => {}).catch((e) => $.log('刷新CDN异常', e));
    await $.wait(1000)
    $.authorCode = await getAuthorShareCode('https://raw.githubusercontent.com/captainz236/sharecode/main/jdsc/jd_updateBeanHome.json') || []
  }
  if (!cookiesArr[0]) {
